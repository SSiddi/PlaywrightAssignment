...
public class DemoGetRequest {
	...
	@Test
	public void getDogBreedDetails() {
		given().when().get("https://dog.ceo/api/breed/hound/afghan/images").then().statusCode(200);

		String apiUrl = "https://dog.ceo/api/breed/hound/afghan/images";

		Response response = RestAssured.get(apiUrl);

		List<String> fetchedImages = response.jsonPath().getList("message");

		List<String> expectedImages = List.of("https://images.dog.ceo/breeds/hound-afghan/n02088094_1003.jpg",
		...
		System.out.println(fetchedImages);
		Assert.assertEquals(fetchedImages, expectedImages);
	}
}
